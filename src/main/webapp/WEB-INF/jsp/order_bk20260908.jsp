...
<main>
    ...
    <form method="get" action="${pageContext.request.contextPath}/order" class="toolbar">
		...
		<option value="C0001" ${clientId == 'C0001' ? 'selected' : '' }>株式会社サンプル商事</option>
		<option value="C0002" ${clientId == 'C0002' ? 'selected' : '' }>有限会社テスト工業</option>
		<option value="C0003" ${clientId == 'C0003' ? 'selected' : '' }>株式会社デモシステムズ</option>
		</select>
